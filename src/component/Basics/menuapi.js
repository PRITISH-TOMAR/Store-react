const Menu = [
  {
   ...
   author: "- Abraham Silberschatz, Henry F. Korth",
    ...
    price: "789₹",
    description:
      "The sixth edition of Database System Concepts is popularly considered to be one of the cornerstone texts of database education. The basic and fundamental concepts are presented in an intuitive manner, and is designed to help students begin working with databases as soon as possible.The book commences with a basic introduction, which discusses fundamental topics like Database Languages, Database Users and Administrators, Database Design, and Data Storage and Querying.This edition also provides a revised coverage of SQL, with greater attention to variants of SQL in actual systems and SQL features.",
  },

  {
    id: 2,
    image: "images/book3.jpg",
    name: "Computer Algorithms (CC+ Version)",
  author: "- Elljb Horowit",
    category: "Algorithms",
    price: "17288₹",
    description:
      "Picking up where their classic Fundamentals of Computer Algorithms left off, the acclaimed Horowitz/Sahni team offers this new title, available in both Pseudocode and C++ versions. This well-researched text takes a solid, theoretical approach to the subject and lays a basis for more in-depth study while providing opportunities for hands-on learning. Computer Science Press C++ Version, 1997",
  },
  {
    id: 3,
